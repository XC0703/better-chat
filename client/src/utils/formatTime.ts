...
export const toggleTime_call = (duration: number) => {
  const hour = duration / 3600 < 10 ? '0' + Math.floor(duration / 3600) : Math.floor(duration / 3600);
  const minute = ((duration % 3600) / 60) < 10 ? '0' + Math.floor((duration % 3600) / 60) : Math.floor((duration % 3600) / 60);
