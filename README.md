...
**本人整理出项目的核心开发教程如下，确保对上述技术栈几乎陌生的小白，跟着教程也完全可以从 0 到 1 实现项目。**
...
- [storage、axios 的二次封装](https://juejin.cn/post/7269703885429948435#heading-7)

登录鉴权、前端路由系统、建立聊天、音视频通话、本地文件系统等核心功能的实现逻辑：

- [个人全栈聊天项目里面的核心功能是怎样实现的？](https://juejin.cn/spost/7440439432644395060)
- [《React+Nest 实现大文件分片上传、断点续传、秒传、重传》](https://juejin.cn/post/7429626822868189193)
...
- 前端引入`Zustand`等库进行状态管理，后端进一步利用`Redis`、`消息队列`等措施进行性能优化。
